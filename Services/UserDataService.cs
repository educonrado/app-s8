...
namespace app_s8.Services
{
    public class UserDataService
    {
        ...
        public UserDataService(FirestoreDb firestoreInstance, UserService userServiceInstance)
        {
            _db = firestoreInstance;
            _userService = userServiceInstance;
        }

        public async Task<Usuario> CargarOCrearDatosUsuarioAsync()
        {
